...
begin
  ...
  con.execute "CREATE TABLE game_sales(id INTEGER PRIMARY KEY AUTOINCREMENT,
    game_code VARCHAR(20), parsed_game_code VARCHAR(20), nsuid VARCHAR(20),
    region VARCHAR(20), title VARCHAR(75), cover_url VARCHAR(200),
    value decimal, onsale boolean, country VARCHAR(50))"
  #con.execute "ALTER SEQUENCE game_sale_id_seq OWNED BY game_sales.id;"
